...
public class ContactsFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        recyclerView=contactsView.findViewById(R.id.contacts_list);
    ...
    public void onStart() {
        ...
        final FirebaseRecyclerAdapter<Contacts, ContactsViewHolder> adapter = new FirebaseRecyclerAdapter<Contacts, ContactsViewHolder>(options) {
            ...
            protected void onBindViewHolder(@NonNull final ContactsViewHolder holder, int position, @NonNull  Contacts model) {
                ...
                String usrIds = getRef(position).getKey();

                userRef.child(usrIds).addValueEventListener(new ValueEventListener() {
                    @Override
                    ...
                    if(dataSnapshot.hasChild("image")){
                       ...
                       Picasso.with(getContext()).load(profileImage).placeholder(R.drawable.profile_image).into(holder.profileImage);
